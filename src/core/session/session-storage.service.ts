...
@Injectable()
export class SessionRedisStorage extends AbstractRedisService<"REDIS_SESSION"> implements ISessionStorage {
	public readonly NAMESPACE = "REDIS_SESSION:" as "REDIS_SESSION";
}
